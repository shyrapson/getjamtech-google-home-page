...
function Main() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        const searchTerm = Loader.current.value
        router.push(`https://www.google.com/search?q=${searchTerm}`)
    }
    return (
        < div >
            <div className="flex justify-center mb-5 ">
                <Image className="" src={Google} alt="images" />
            </div>

            <form onSubmit={handleSubmit} className={`${style.inputWrapper} border-gray-400 border mt-5 w-auto  md:hover:border-gray-200
             ...
             rounded-3xl mt-5 md:w-5/12 md:m-auto `} >
                ...
                <input type="text" ref={Loader} className="outline-none font-sm
                  pr-3 pl-3 text-sm h-9 md:text-base w-full md:w-full"  required />
            ...
            <div className=" w-3/6 mx-auto flex justify-center hidden md:flex text-sm items-center my-8 ">
            ...
            <div className=" w-11/12 mx-auto flex flex-col md:flex-row justify-center items-center mt-5 md:w-2/6">
